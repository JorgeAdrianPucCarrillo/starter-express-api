...
router.get('/get/one/:nftMetadata', getNFTMetaDataController);
...
router.post('/created/nft/mint', mintNftController);//crea y agrega un nft creado a la blokchain 
router.post('/send', sendNftController);
